  ...
  if (isSuccess) {
    return (
      <div className="text-center py-8">
        ...
        <h3 className="text-3xl font-bold text-slate-900 mb-3 tracking-tight">Check your email!</h3>
        <p className="text-slate-600 mb-8 text-lg">
          We've sent a magic link to <strong className="text-slate-900">{email}</strong>. Click it to log in and start your free trial.
        </p>
