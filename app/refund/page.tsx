          ...
          <section className="space-y-5">
            ...
            <div className="pl-13 md:pl-13 text-lg leading-relaxed text-slate-600">
              ...
              <div className="bg-slate-50 border border-slate-200 rounded-2xl p-6 md:p-8 space-y-4">
                ...
                <a href="https://wa.me/917976123042?text=Hi%20PropDesk%20Support,%20I%20need%20help%20with%20an%20issue" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 group p-3 rounded-xl hover:bg-white hover:shadow-sm transition-all border border-transparent hover:border-slate-100">
                  ...
                  <div>
                    ...
                    <span className="block text-lg font-semibold text-emerald-650">+91 79761 23042</span>
                  </div>
                </a>

                <a href="tel:+917976123042" className="flex items-center gap-4 group p-3 rounded-xl hover:bg-white hover:shadow-sm transition-all border border-transparent hover:border-slate-100">
                  ...
                  <div>
                    ...
                    <span className="block text-lg font-semibold text-slate-700">+91 79761 23042</span>
                  </div>
                </a>
